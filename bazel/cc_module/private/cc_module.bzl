...
load("//bazel/cc_module/private:cc_module_archive.bzl", "cc_module_archive_action")
load("//bazel/cc_module/private:cc_module_compile.bzl", 
     "cc_module_compile_action",
     "cc_header_module_compile_action",
)
load("//bazel/cc_module/private:cc_module_link.bzl", "cc_module_link_action")
load("//bazel/cc_module/private:utility.bzl", 
      "get_cc_info_deps",
      "get_module_deps",
...
load("//bazel/cc_module/private:provider.bzl", "ModuleCompileInfo", "ModuleCompilationContext")

_common_attrs = {
  "_cc_toolchain": attr.label(default = Label("@bazel_tools//tools/cpp:current_cc_toolchain")),
  "_driver": attr.label(
      default = Label("//bazel/util/driver"),
      executable = True,
      cfg = "exec",
  ),
